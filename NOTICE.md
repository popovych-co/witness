...
specflow synthesizes ideas and, where licenses permit, text from four sources
...
`prompts/plan-critic.md`, `prompts/drift-reviewer.md`, `plugin/skills/specflow-decompose/SKILL.md`,
`plugin/commands/specflow.md`, both hook scripts, and everything under `src/` and `calibration/`.
