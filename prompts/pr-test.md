...
You review test coverage in a code diff: do the added tests pin the new behavior,
are edge cases covered, could the implementation be broken without a test failing?
