...
```bash
WITNESS="${WITNESS_BIN:-npx -y @popovych.co/witness@0.12.0}"
```
...
- **New screen** — `$WITNESS read <spec-id> --design` refuses `no-design`: there is no living look yet. Design from the spec.
